...
} = require("../Middleware/AutenticacaoUsuario/verificarAutenticacao.js");
...
const {
  detalharCliente,
} = require("../Controllers/Clientes/detalharClientes.js");
const {
  atualizarCadCliente,
} = require("../Controllers/Clientes/atualizarCliente.js");
const {
  cadastrarCliente,
} = require("../Controllers/Clientes/cadastrarCliente.js");
const {
  listarStatusClientes,
} = require("../Controllers/Clientes/listarStatusClientes.js");
const rotasCliente = express();

rotasCliente.use(verificarAutenticacao);
rotasCliente.post(
  "/cadastroCliente",
  validarCadCliente(schemaCliente),
  cadastrarCliente
);
rotasCliente.patch(
  "/cliente/atualizar_cadastro/:id",
  validarAttCliente(schemaAttCliente),
  atualizarCadCliente
);
