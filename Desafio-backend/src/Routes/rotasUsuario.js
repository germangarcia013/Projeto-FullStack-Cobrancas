...
const {
  atualizarUsuario,
} = require("../Controllers/Usuarios/atualizarUsuario.js");
...
const {
  listarUsuarioLogado,
} = require("../Controllers/Usuarios/listarUsuarioLogado.js");
...
rotasUsuario.post(
  "/usuario/cadastro",
  validarCadastro(schemaCadastro),
  cadastrarUsuario
);
...
rotasUsuario.patch(
  "/usuario/atualizar",
  validarAtualizacao(schemaAtualizacao),
  atualizarUsuario
);
